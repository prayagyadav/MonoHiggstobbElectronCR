...
#-rw-rw-r-- 1 bsahu bsahu  33K Mar 27 23:14 CR_DataA_BCatTope_2018_from_1_to_40.coffea
#-rw-rw-r-- 1 bsahu bsahu  30K Mar 27 23:14 CR_DataB_BCatTope_2018_from_1_to_22.coffea
#-rw-rw-r-- 1 bsahu bsahu  30K Mar 27 23:14 CR_DataC_BCatTope_2018_from_1_to_24.coffea
#-rw-rw-r-- 1 bsahu bsahu  29K Mar 27 23:14 CR_DataD_BCatTope_2018_from_101_to_121.coffea
#-rw-rw-r-- 1 bsahu bsahu  32K Mar 27 23:14 CR_DataD_BCatTope_2018_from_1_to_50.coffea
#-rw-rw-r-- 1 bsahu bsahu  32K Mar 27 23:14 CR_DataD_BCatTope_2018_from_51_to_100.coffea
#-rw-rw-r-- 1 bsahu bsahu 694K Mar 27 23:14 CR_MCSingleTop1_BCatTope_2018_from_101_to_150.coffea
#-rw-rw-r-- 1 bsahu bsahu 549K Mar 27 23:14 CR_MCSingleTop1_BCatTope_2018_from_151_to_200.coffea
#-rw-rw-r-- 1 bsahu bsahu 671K Mar 27 23:14 CR_MCSingleTop1_BCatTope_2018_from_1_to_50.coffea
#-rw-rw-r-- 1 bsahu bsahu 589K Mar 27 23:14 CR_MCSingleTop1_BCatTope_2018_from_201_to_250.coffea
#-rw-rw-r-- 1 bsahu bsahu 451K Mar 27 23:14 CR_MCSingleTop1_BCatTope_2018_from_251_to_279.coffea
#-rw-rw-r-- 1 bsahu bsahu 680K Mar 27 23:14 CR_MCSingleTop1_BCatTope_2018_from_51_to_100.coffea
#-rw-rw-r-- 1 bsahu bsahu 804K Mar 27 23:14 CR_MCSingleTop2_BCatTope_2018_from_1_to_52.coffea
#-rw-rw-r-- 1 bsahu bsahu 805K Mar 27 23:14 CR_MCSingleTop2_BCatTope_2018_from_53_to_75.coffea
#-rw-rw-r-- 1 bsahu bsahu 905K Mar 27 23:14 CR_MCTTbar1l1v_BCatTope_2018_from_1_to_47.coffea
#-rw-rw-r-- 1 bsahu bsahu 2.8M Mar 27 23:14 CR_MCWlvJets_BCatTope_2018_from_101_to_164.coffea
#-rw-rw-r-- 1 bsahu bsahu 649K Mar 27 23:14 CR_MCWlvJets_BCatTope_2018_from_1_to_50.coffea
#-rw-rw-r-- 1 bsahu bsahu 1.3M Mar 27 23:14 CR_MCWlvJets_BCatTope_2018_from_51_to_100.coffea

outputData = accumulate([
    util.load("coffea_files/ver5/CR_DataA_BCatTope_2018_from_1_to_40.coffea"),
    util.load("coffea_files/ver5/CR_DataB_BCatTope_2018_from_1_to_22.coffea"),
    util.load("coffea_files/ver5/CR_DataC_BCatTope_2018_from_1_to_24.coffea"),
    util.load("coffea_files/ver5/CR_DataD_BCatTope_2018_from_1_to_50.coffea"),
    util.load("coffea_files/ver5/CR_DataD_BCatTope_2018_from_51_to_100.coffea"),
    util.load("coffea_files/ver5/CR_DataD_BCatTope_2018_from_101_to_121.coffea"),
])  
outputMC = accumulate([
    util.load("coffea_files/ver5/CR_MCTTbar1l1v_BCatTope_2018_from_1_to_47.coffea"),
    util.load("coffea_files/ver5/CR_MCSingleTop1_BCatTope_2018_from_1_to_50.coffea"),
    util.load("coffea_files/ver5/CR_MCSingleTop1_BCatTope_2018_from_51_to_100.coffea"),
    util.load("coffea_files/ver5/CR_MCSingleTop1_BCatTope_2018_from_101_to_150.coffea"),
    util.load("coffea_files/ver5/CR_MCSingleTop1_BCatTope_2018_from_151_to_200.coffea"),
    util.load("coffea_files/ver5/CR_MCSingleTop1_BCatTope_2018_from_201_to_250.coffea"),
    util.load("coffea_files/ver5/CR_MCSingleTop1_BCatTope_2018_from_251_to_279.coffea"),
    util.load("coffea_files/ver5/CR_MCSingleTop2_BCatTope_2018_from_1_to_52.coffea"),
    util.load("coffea_files/ver5/CR_MCSingleTop2_BCatTope_2018_from_53_to_75.coffea"),
    util.load("coffea_files/ver5/CR_MCWlvJets_BCatTope_2018_from_1_to_50.coffea"),
    util.load("coffea_files/ver5/CR_MCWlvJets_BCatTope_2018_from_51_to_100.coffea"),
    util.load("coffea_files/ver5/CR_MCWlvJets_BCatTope_2018_from_101_to_164.coffea"),
])
...
for key in outputHistMC.keys():
    if key.startswith('Cutflow_BCat_CRTope'): 
        ...
        np.savetxt('plots/ver5/boosted/e/'+str(key)+'_table_2018.txt', df.values, delimiter="\t", fmt='%d\t%s\t%.2e\t%.2e\t%.3f') 
        print("Cutflow saved")
        ...
        plt.savefig('plots/ver5/boosted/e/'+str(key)+'_plot_2018.png')
...
def make_kinematicplot(var, Xlabel, rebin_factor, logY, xRange=None):
    ...
    plt.savefig('plots/ver5/boosted/e/'+var+'_BCatTope_2018.png')
...
def make_debug_kinematicplot(debugvar, var, Xlabel, rebin_factor, logY, xRange=None):
    ...
    figr, (ax) = plt.subplots(1)
    plotWithRatio(h=h1, hData=hData, overlay='dataset', logY=logY, xLabel=Xlabel, xRange=xRange, colors_cat='Topmu', extraText=extraText, lumi=59.83, year=2018)
    plt.savefig('plots/ver5/boosted/e/'+var+debugvar+'_BCatTope_2018.png')
...
def make_kinematicplot_2d(var, whichtau, Xlabel, rebin_factor, logY, xRange=None):
    ...
    plt.savefig('plots/ver5/boosted/e/FJet_'+whichtau+'_2018.png')
...
def checkSyst_nomUpDown(var, var_axis, syste, Title):
    ...
    plt.savefig('plots/ver5/boosted/e/'+str(var)+'_'+str(syste)+'_updown_2018.png') 
