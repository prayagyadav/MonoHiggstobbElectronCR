...
util.save(output, "monoHbb/efficiencies/btagEfficiencyLMTwps_MCBkgs_UL2017_tmp.coffea")
...
btagEff_ptBins = np.array([30, 50, 70, 100, 140, 200, 300, 500, 1000])
btagEff_etaBins = np.array([0.5, 1., 1.5, 2., 2.5])
flavors = np.array([0, 4, 5])
...
taggingEffLookup = dense_lookup.dense_lookup(np.array(btagEff), (np.array(samples), flavors, btagEff_ptBins, btagEff_etaBins))
#print('taggingEffLookup :', taggingEffLookup, ' \n')

'''
print('np.array(btagEff): ', np.array(btagEff), ' \n')
print('np.array(samples): ', np.array(samples), ' \n')
print('flavors,: ', flavors, ' \n')
print('btagEff_ptBins: ', btagEff_ptBins, ' \n')
print('btagEff_etaBins: ', btagEff_etaBins, ' \n')
'''
...
with open("monoHbb/scalefactors/taggingEfficienciesDenseLookupLooseWP_MCBkgs_UL2017_tmp.pkl", "wb") as _file:
