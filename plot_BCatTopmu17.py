...
outputData = accumulate([
    util.load("2017/Outputs_Test6b_BCatTopmu/output_DataB_Test6bBCatTopmu2017_run20240110_133754.coffea"),
    util.load("2017/Outputs_Test6b_BCatTopmu/output_DataC_Test6bBCatTopmu2017_run20240110_141916.coffea"),
    util.load("2017/Outputs_Test6b_BCatTopmu/output_DataD_Test6bBCatTopmu2017_run20240110_090228.coffea"),
    util.load("2017/Outputs_Test6b_BCatTopmu/output_DataE_Test6bBCatTopmu2017_run20240110_140857.coffea"),
    util.load("2017/Outputs_Test6b_BCatTopmu/output_DataF_Test6bBCatTopmu2017_run20240110_145435.coffea"),
])

outputMC = accumulate([
    util.load("2017/Outputs_Test6c_BCatTopmu/output_MCTTbar1l1v_Test6cBCatTopmu2017_run20240201_110705.coffea"),
    util.load("2017/Outputs_Test6c_BCatTopmu/output_MCTTbar2l2v_Test6cBCatTopmu2017_run20240201_114916.coffea"),
    util.load("2017/Outputs_Test6c_BCatTopmu/output_MCTTbar0l0v_Test6cBCatTopmu2017_run20240202_104631.coffea"),
    util.load("2017/Outputs_Test6c_BCatTopmu/output_MCSingleTop1_Test6cBCatTopmu2017_run20240201_144553.coffea"),
    util.load("2017/Outputs_Test6c_BCatTopmu/output_MCSingleTop2_Test6cBCatTopmu2017_run20240201_131922.coffea"),
    util.load("2017/Outputs_Test6c_BCatTopmu/output_MCWlvJets_Test6cBCatTopmu2017_run20240201_180056.coffea"),
])
...
for key in outputHistMC.keys():
    if key.startswith('Cutflow_BCat_CRTopmu'): 
        ...
        np.savetxt('2017/Plots_Test6c_BCatTopmu/'+str(key)+'_table_2017.txt', df.values, delimiter="\t", fmt='%d\t%s\t%.2e\t%.2e\t%.3f') 

        # make cutflow plot
        hMC = outputHistMC[key]
        hData = outputHistData[key][{'dataset':sum}]
        plotWithRatio(h=hMC, hData=hData, overlay='dataset', logY=True, xLabel='Selection Bin', xRange=None, colors_cat='Topmu', extraText=None, lumi=LumiVal, year=Year)
        plt.savefig('2017/Plots_Test6c_BCatTopmu/'+str(key)+'_plot_2017.png')
...
def make_kinematicplot(var, Xlabel, rebin_factor, logY, xRange=None):
    ...
    plt.savefig('2017/Plots_Test6c_BCatTopmu/'+var+'_BCatTopmu_2017.png')
...
make_kinematicplot(var="Muon_pT", Xlabel=r"Muon $p_{T}$ [GeV]", rebin_factor=6, logY=True, xRange=[0.,800.])
...
make_kinematicplot(var="FJet_pT", Xlabel=r"FatJet $p_{T}$ [GeV]", rebin_factor=6, logY=True, xRange=[0.,1000.])
...
def make_kinematicplot_2d(var, whichtau, Xlabel, rebin_factor, logY, xRange=None):
    ...
    figr, (ax) = plt.subplots(1)
    plotWithRatio(h=hMC_, hData=hData_, overlay='dataset', logY=logY, xLabel=Xlabel, xRange=xRange, colors_cat='Topmu', extraText=extraText, lumi=LumiVal, year=Year)
    plt.savefig('2017/Plots_Test6c_BCatTopmu/FJet_'+whichtau+'_2017.png')
...
def checkSyst_nomUpDown(var, var_axis, syste, Title):
    ...
    plt.savefig('2017/Plots_Test6c_BCatTopmu/'+str(var)+'_'+str(syste)+'_updown_2017.png') 
